...
namespace Binance.API.Csharp.Client
{
    public class BinanceClient : BinanceClientAbstract, IBinanceClient
    {
        ...
        private void LoadTradingRules()
        {
            ...
            _tradingRules = JsonConvert.DeserializeObject<TradingRules>(apiClient.CallAsync<TradingRules>(ApiMethod.GET, "").Result);
        }
        #endregion
        ...
        {
            var result = _apiClient.CallAsync<ServerInfo>(ApiMethod.GET, EndPoints.CheckServerTime, false);

            return JsonConvert.DeserializeObject<ServerInfo>(result.Result); 
        }
        #endregion
        ...
        public async Task<IEnumerable<AggregateTrade>> GetAggregateTrades(string symbol, int limit = 500)
        {
            ...
            return JsonConvert.DeserializeObject<IEnumerable<AggregateTrade>>(result);
            //return result;
        }
        ...
        public async Task<IEnumerable<Candlestick>> GetCandleSticks(string symbol, TimeInterval interval, DateTime? startTime = null, DateTime? endTime = null, int limit = 500)
        {
            ...
            var result = _apiClient.CallAsync<dynamic>(ApiMethod.GET, EndPoints.Candlesticks, false, args).Result;

            //var parser = new CustomParser();IEnumerable<Candlestick>
            ...
            foreach (var item in data)
            {
                ...
                {
                    OpenTime = long.Parse(item[0].ToString().Replace(".",",")),
                    ...
                    CloseTime = long.Parse(item[6].ToString().Replace(".", ",")),
                    QuoteAssetVolume = decimal.Parse(item[7].ToString().Replace(".", ",")),
                    NumberOfTrades = int.Parse(item[8].ToString().Replace(".", ",")),
        ...
        public async Task<IEnumerable<PriceChangeInfo>> GetPriceChange24H(string symbol = "")
        {
            ...
            {
                var data =    JsonConvert.DeserializeObject<PriceChangeInfo>(_apiClient.CallAsync<PriceChangeInfo>(ApiMethod.GET, EndPoints.TickerPriceChange24H, false, args).Result);
                result.Add(data);
            }
            else
            {
                result = JsonConvert.DeserializeObject<List<PriceChangeInfo>>(_apiClient.CallAsync<List<PriceChangeInfo>>(ApiMethod.GET, EndPoints.TickerPriceChange24H, false, args).Result);
            }
        ...
        {
            var result =  _apiClient.CallAsync<IEnumerable<SymbolPrice>>(ApiMethod.GET, EndPoints.AllPrices, false).Result;
            return JsonConvert.DeserializeObject<IEnumerable<SymbolPrice>>(result);
            //return result;
        }
        ...
        public async Task<IEnumerable<OrderBookTicker>> GetOrderBookTicker()
        {
            ...
            return JsonConvert.DeserializeObject<IEnumerable<OrderBookTicker>>(result);
        }
        #endregion
        ...
        public async Task<NewOrder> PostNewOrder(string symbol, decimal quantity, decimal price, OrderSide side, OrderType orderType = OrderType.LIMIT, TimeInForce timeInForce = TimeInForce.GTC, decimal icebergQty = 0m, long recvWindow = 5000)
        {
            ...
            return JsonConvert.DeserializeObject<NewOrder>(result);
        }
        ...
        public async Task<CanceledOrder> CancelOrder(string symbol, long? orderId = null, string origClientOrderId = null, long recvWindow = 5000)
        {
            ...
            return JsonConvert.DeserializeObject<CanceledOrder>(result);
        }
        ...
        public async Task<IEnumerable<Trade>> GetTradeList(string symbol, long recvWindow = 5000)
        {
            ...
            return JsonConvert.DeserializeObject<IEnumerable<Trade>>(result);
        }
        ...
        public async Task<WithdrawResponse> Withdraw(string asset, decimal amount, string address, string addressName = "", long recvWindow = 5000)
        {
            ...
            return JsonConvert.DeserializeObject<WithdrawResponse>(result);
        }
        ...
        public async Task<DepositHistory> GetDepositHistory(string asset, DepositStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, long recvWindow = 5000)
        {
            ...
            return JsonConvert.DeserializeObject<DepositHistory>(result);
        }
        ...
        public async Task<WithdrawHistory> GetWithdrawHistory(string asset, WithdrawStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, long recvWindow = 5000)
        {
            ...
            return JsonConvert.DeserializeObject<WithdrawHistory>(result);
        }
        #endregion
        ...
        public async Task<UserStreamInfo> StartUserStream()
        {
            ...
            return JsonConvert.DeserializeObject<UserStreamInfo>(result);
        }
        /// <summary>
